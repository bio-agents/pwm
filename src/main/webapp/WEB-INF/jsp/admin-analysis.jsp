                                ...
                                <script type="application/javascript">
                                    PWM_GLOBAL['startupFunctions'].push(function(){
                                        PWM_MAIN.showAgenttip({
                                            ...
                                            text: '<pwm:display key="Agenttip_DownloadReportRecords" bundle="Admin"/>',
                                            width: 350
                                        });
                                    });
                                </script>
    ...
    <script type="text/javascript">
        ...
        PWM_GLOBAL['startupFunctions'].push(function(){
            require(["dojo/parser","dijit/registry","dojo/ready","dijit/form/Select","dijit/form/NumberSpinner","dijit/layout/TabContainer","dijit/layout/ContentPane"],function(dojoParser,registry,ready){
                ...
                <% for (Statistic loopStat : Statistic.sortedValues(locale)) { %>
                PWM_MAIN.showAgenttip({id:'Statistic_Key_<%=loopStat.getKey()%>',width:400,position:'above',text:PWM_ADMIN.showString("Statistic_Description.<%=loopStat.getKey()%>")});
                <% } %>
