    ...
    <div class="configeditor-header" id="header" >
        <div id="header-center-wide" style="min-width: 850px">
            <div id="header-title">
                ...
                <div class="headerIcon" id="cancelButton_icon" title="<pwm:display key="Agenttip_CancelEditorButton" bundle="Config"/>">
                    <span class="fa fa-times"></span>
                </div>
                <div class="headerIcon" id="saveButton_icon" title="<pwm:display key="Agenttip_SaveEditorButton" bundle="Config"/>">
                    <span class="fa fa-save"></span>
                </div>
                <div class="headerIcon" id="setPassword_icon" title="<pwm:display key="Agenttip_SetConfigPasswordButton" bundle="Config"/>">
                    <span class="fa fa-key"></span>
                </div>
                <div class="headerIcon" id="referenceDoc_icon" title="<pwm:display key="Agenttip_OpenReferenceDocButton" bundle="Config"/>">
                    <span class="fa fa-book"></span>
                </div>
                <div class="headerIcon" id="macroDoc_icon" title="<pwm:display key="Agenttip_OpenMacroHelpButton" bundle="Config"/>">
    ...
    <div id="centerbody-config" class="centerbody-config">
        <div id="settingSearchPanel">
            <table class="noborder settingSearchPanelTable">
                ...
                <tr>
                    <td>
                        <span id="settingSearchIcon" class="fa fa-search" title="<pwm:display key="Agenttip_IconSettingsSearch" bundle="Config"/>"></span>
                    </td>
                    <td>
                    ...
                    <td>
                        <div style="margin-top:5px; width:20px; max-width: 20px;">
                            ...
                            <div id="indicator-noResults" style="display: none;" title="<pwm:display key="Agenttip_IconSearchNoResults" bundle="Config"/>">
        ...
        <div id="navigationTreeWrapper" style="display:none">
            ...
            <div id="navTreeExpanderButtons">
                <span id="button-navigationExpandAll" class="fa fa-plus-square" title="<pwm:display key="Agenttip_IconExpandAll" bundle="Config"/>"></span>
                &nbsp;&nbsp;
                <span id="button-navigationCollapseAll" class="fa fa-minus-square" title="<pwm:display key="Agenttip_IconCollapseAll" bundle="Config"/>"></span>
                &nbsp;&nbsp;
                <div class="headerIcon" id="settingFilter_icon" title="<pwm:display key="Agenttip_IconFilterSettings" bundle="Config"/>">
